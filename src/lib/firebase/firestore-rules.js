...
//   match /databases/{database}/documents/employees/{employeeId} {
...
//   match /databases/{database}/documents/leaveRequests/{requestId} {
...
//   match /databases/{database}/documents/departments/{departmentId} {
...
//   match /databases/{database}/documents/auditLogs/{logId} {
...
//   match /databases/{database}/documents/settings/{settingId} {
...
//   match /databases/{database}/documents/invitationCodes/{codeId} {
